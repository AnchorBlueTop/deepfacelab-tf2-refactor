# --- START OF core/leras/ops/__init__.py --- (Revised Imports)
import numpy as np
from core.leras import nn
import tensorflow as tf # Import main TF directly
# Import specific ops if still needed by functions below
from tensorflow.python.ops import array_ops, random_ops, math_ops, sparse_ops
# from tensorflow.python.ops import gradients # REMOVE THIS LINE
from tensorflow.python.framework import sparse_tensor # Keep if sparse ops are used
